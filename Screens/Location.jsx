...
export default function LocationScreen({ route }) {
  ...
  try {
    ...
    await auditLog({
      action: "LOCATION_FETCHED",
      page: "Location Activity",
      element: "Current Location",
      description: "User's current location was successfully retrieved",
      details: {
    ...
    await auditLog({
      ...
      page: "Location Activity",
      element: "Current Location",
      description: "Failed to retrieve user's current location",
      details: {
...
>
  ...
  <TouchableOpacity
    ...
    onPress={async () => {
      await auditLog({
        action: "RESET_RECEIPT_SCANNER",
        page: "Location Activity",
        description: "User reset the fuel receipt scanner",
        element: "Reset Receipt Scanner",
        targetId: tripId,
        details: {
          trip_id: tripId,
        },
