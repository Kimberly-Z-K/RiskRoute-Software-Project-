...
// REMOVED: import SimulationResults from './components/simulation/SimulationResults';
...
function App() {
      ...
      <div className="flex h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="p-4 md:p-6">
            ...
            {/* Simulation Screen - REMOVED SimulationResults */}
  ...
  <Routes>
    ...
    <Route 
      path="/" 
      element={
        isAuthenticated ? <DashboardContent /> : <Navigate to="/login" replace />
      } 
    />
